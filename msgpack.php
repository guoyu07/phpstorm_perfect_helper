 ...
 * @param string|string[] $NeedPackedInput
 * @return bool|string
 */
function msgpack_pack($NeedPackedInput){}
/**
 * unpack the data which pack with msgpack
 * @param string $NeedUnPackedInput
 * @return bool|string|string[]
 */
function msgpack_unpack($NeedUnPackedInput){}